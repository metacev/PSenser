...
class DeviceInfoFragment : Fragment() {
    ...
    private fun updateDeviceInfo() {
        ...
        val androidVersionName = PermissionHelper.getAndroidVersionName(deviceSummary.sdkVersion)
        textViewAndroidVersion?.text = "$androidVersionName (API ${deviceSummary.sdkVersion})"
